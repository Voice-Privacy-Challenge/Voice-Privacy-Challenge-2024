...
# Modify run_evaluation(s) configs
eval_overwrite=
...
python run_evaluation.py --config eval_pre.yaml ${eval_overwrite}

# Train post ASV using anonymized libri-360 and perform libri dev+test post evaluation
# ASV training takes 2hours
python run_evaluation.py --config eval_post.yaml ${eval_overwrite}
